...
#pragma omp for collapse(1) nowait
...
#pragma unroll 2
                ...
                for (int j = 3; j < 7; j += 4) {
                    __m128 sum = _mm_setzero_ps();
                    __m128 img_val0 = _mm_loadu_ps(input_img + (i - 1) * num_cols + j - 1);
                    __m128 img_val1 = _mm_loadu_ps(input_img + (i - 1) * num_cols + j);
                    __m128 img_val2 = _mm_loadu_ps(input_img + (i - 1) * num_cols + j + 1);
                    __m128 img_val3 = _mm_loadu_ps(input_img + i * num_cols + j - 1);
                    __m128 img_val4 = _mm_loadu_ps(input_img + i * num_cols + j);
                    __m128 img_val5 = _mm_loadu_ps(input_img + i * num_cols + j + 1);
                    __m128 img_val6 = _mm_loadu_ps(input_img + (i + 1) * num_cols + j - 1);
                    __m128 img_val7 = _mm_loadu_ps(input_img + (i + 1) * num_cols + j);
                    __m128 img_val8 = _mm_loadu_ps(input_img + (i + 1) * num_cols + j + 1);
                ...
                for (int j = 7; j < 15; j += 8) {
                    __m256 sum = _mm256_setzero_ps();
                    __m256 img_val0 = _mm256_loadu_ps(input_img + (i - 1) * num_cols + j - 1);
                    __m256 img_val1 = _mm256_loadu_ps(input_img + (i - 1) * num_cols + j);
                    __m256 img_val2 = _mm256_loadu_ps(input_img + (i - 1) * num_cols + j + 1);
                    __m256 img_val3 = _mm256_loadu_ps(input_img + i * num_cols + j - 1);
                    __m256 img_val4 = _mm256_loadu_ps(input_img + i * num_cols + j);
                    __m256 img_val5 = _mm256_loadu_ps(input_img + i * num_cols + j + 1);
                    __m256 img_val6 = _mm256_loadu_ps(input_img + (i + 1) * num_cols + j - 1);
                    __m256 img_val7 = _mm256_loadu_ps(input_img + (i + 1) * num_cols + j);
                    __m256 img_val8 = _mm256_loadu_ps(input_img + (i + 1) * num_cols + j + 1);
